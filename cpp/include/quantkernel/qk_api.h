...
QK_EXPORT int32_t qk_mcm_stratified_sampling_price_batch(const double* spot, const double* strike,
                                                           ...
                                                           const uint64_t* seed,
                                                           int32_t n, double* out_prices);
QK_EXPORT double qk_mcm_heston_monte_carlo_price(double spot, double strike, double t,
                                                  double r, double q,
                                                  double v0, double kappa, double theta,
                                                  double sigma, double rho,
                                                  int32_t option_type,
                                                  int32_t paths, int32_t steps, uint64_t seed);
QK_EXPORT int32_t qk_mcm_heston_monte_carlo_price_batch(const double* spot, const double* strike,
                                                         const double* t,
                                                         const double* r, const double* q,
                                                         const double* v0, const double* kappa,
...
QK_EXPORT int32_t qk_ftm_hilbert_transform_price_batch(const double* spot, const double* strike,
                                                         ...
                                                         const double* integration_limit,
                                                         int32_t n, double* out_prices);
QK_EXPORT double qk_ftm_carr_madan_fft_heston_price(double spot, double strike, double t,
                                                     double r, double q,
                                                     double v0, double kappa, double theta,
                                                     double sigma, double rho,
                                                     int32_t option_type,
                                                     int32_t grid_size, double eta, double alpha);
QK_EXPORT double qk_ftm_cos_fang_oosterlee_heston_price(double spot, double strike, double t,
                                                         double r, double q,
                                                         double v0, double kappa, double theta,
                                                         double sigma, double rho,
                                                         int32_t option_type,
                                                         int32_t n_terms, double truncation_width);
QK_EXPORT double qk_ftm_fractional_fft_heston_price(double spot, double strike, double t,
                                                     double r, double q,
                                                     double v0, double kappa, double theta,
                                                     double sigma, double rho,
                                                     int32_t option_type,
...
QK_EXPORT double qk_ftm_lewis_fourier_inversion_heston_price(double spot, double strike, double t,
                                                              double r, double q,
                                                              double v0, double kappa, double theta,
                                                              double sigma, double rho,
                                                              int32_t option_type,
                                                              int32_t integration_steps,
                                                              double integration_limit);
QK_EXPORT double qk_ftm_hilbert_transform_heston_price(double spot, double strike, double t,
                                                        double r, double q,
                                                        double v0, double kappa, double theta,
                                                        double sigma, double rho,
                                                        int32_t option_type,
                                                        int32_t integration_steps,
                                                        double integration_limit);
QK_EXPORT int32_t qk_ftm_carr_madan_fft_heston_price_batch(const double* spot, const double* strike,
                                                            const double* t, const double* r, const double* q,
                                                            const double* v0, const double* kappa,
                                                            const double* theta, const double* sigma,
                                                            const double* rho, const int32_t* option_type,
                                                            ...
                                                            const double* alpha,
                                                            int32_t n, double* out_prices);
QK_EXPORT int32_t qk_ftm_cos_fang_oosterlee_heston_price_batch(const double* spot, const double* strike,
                                                                const double* t, const double* r, const double* q,
                                                                const double* v0, const double* kappa,
                                                                const double* theta, const double* sigma,
                                                                const double* rho, const int32_t* option_type,
                                                                ...
                                                                const double* truncation_width,
                                                                int32_t n, double* out_prices);
QK_EXPORT int32_t qk_ftm_fractional_fft_heston_price_batch(const double* spot, const double* strike,
                                                            const double* t, const double* r, const double* q,
                                                            const double* v0, const double* kappa,
                                                            const double* theta, const double* sigma,
                                                            const double* rho, const int32_t* option_type,
                                                            ...
                                                            int32_t n, double* out_prices);
QK_EXPORT int32_t qk_ftm_lewis_fourier_inversion_heston_price_batch(const double* spot, const double* strike,
                                                                     const double* t, const double* r, const double* q,
                                                                     const double* v0, const double* kappa,
                                                                     const double* theta, const double* sigma,
                                                                     const double* rho, const int32_t* option_type,
                                                                     ...
                                                                     const double* integration_limit,
                                                                     int32_t n, double* out_prices);
QK_EXPORT int32_t qk_ftm_hilbert_transform_heston_price_batch(const double* spot, const double* strike,
                                                               const double* t, const double* r, const double* q,
                                                               const double* v0, const double* kappa,
                                                               const double* theta, const double* sigma,
                                                               const double* rho, const int32_t* option_type,
